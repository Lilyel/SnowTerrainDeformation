...
namespace ae
{
	...
	/// \ingroup graphics
	/// <summary>
	/// Shader parameter for color uniforms.
	/// </summary>
	/// <seealso cref="Shader"/>
	/// <seealso cref="Material"/>
	/// <seealso cref="ShaderParameter"/>
	/// <seealso cref="Color"/>
	class AERO_CORE_EXPORT ShaderParameterColor : public ShaderParameter
	{
	public:
		/// <summary>
		...
		/// <param name="_Value">Value for the color parameter.</param>
		explicit ShaderParameterColor( const std::string& _Name, const std::string& _UniformName, const Color& _Value );
		...
		ShaderParameter& operator=( const Color& _Value );
		...
		ShaderParameterColor* Clone() const override final;

	private:
		/// <summary>Value of the color parameter.</summary>
		Color m_Value;
	};
} // ae
