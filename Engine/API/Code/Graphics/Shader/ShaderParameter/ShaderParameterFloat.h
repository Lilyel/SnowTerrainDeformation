...
namespace ae
{
	...
	/// \ingroup graphics
	/// <summary>
	/// Shader parameter for decimal uniforms.
	/// </summary>
	/// <seealso cref="Shader"/>
	/// <seealso cref="Material"/>
	/// <seealso cref="ShaderParameter"/>
	class AERO_CORE_EXPORT ShaderParameterFloat : public ShaderParameter
	{
	public:
		/// <summary>
		...
		/// <param name="_Value">Value for the decimal parameter.</param>
		explicit ShaderParameterFloat( const std::string& _Name, const std::string& _UniformName, float _Value );
		...
		ShaderParameter& operator=( float _Value );
		...
		ShaderParameterFloat* Clone() const override final;
	...
	private:
		/// <summary>Value of the decimal parameter.</summary>
		float m_Value;
