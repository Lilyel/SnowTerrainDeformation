...
namespace ae
{
	...
	/// </summary>
	/// <seealso cref="Color"/>
	class AERO_CORE_EXPORT Image : public ImageBase
	{
	public:
		/// <summary>
		...
		explicit Image( const Uint32 _Width, const Uint32 _Height, const ImageFormat _Format );
		...
		Bool LoadFromMemory( const Uint8* _Data, const Uint32 _Width, const Uint32 _Height, const ImageFormat _Format );
	...
	protected : 
		...
		void CopyPixels( const Uint8* _Pixels );
