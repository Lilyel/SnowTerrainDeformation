...
{
	/// \ingroup graphics
	/// <summary>Blinn Phong shading settings for rendering.</summary>
	/// <seealso cref="Material"/>
	class AERO_CORE_EXPORT BlinnPhongMaterial : public Material
	{
	public:
		/// <summary>Set the shader to the default Blinn-Phong shader and create all the shader parameters for it.</summary>
		BlinnPhongMaterial();
