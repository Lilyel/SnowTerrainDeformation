...
namespace ae
{
	...
	/// \ingroup graphics
	/// <summary>
	/// 2D array samplable data that can be link to a shader to be rendered.
	/// </summary>
	class AERO_CORE_EXPORT Texture2DArray : public Texture
	{
	public:
		...
		Texture2DArray( Uint32 _Width, Uint32 _Height, Uint32 _Depth, TexturePixelFormat _Format = TexturePixelFormat::DefaultTexture );
		...
		Texture2DArray( Uint32 _Width, Uint32 _Height, Uint32 _Depth, const FramebufferAttachement& _FramebufferAttachement );
